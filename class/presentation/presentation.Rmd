...
**Jean Prado** (they/them)

Engagement Strategist, Facilitator, Tech 4 Good advocate, R programmer.
...
Usually don't go by a specific format
...
```{r error=TRUE}
(date <- as.Date("16 de dezembro de 2022"))
```
...
- specify format
- fix for this case, but not standard
- have to know the format in this weird way w/ `%`
